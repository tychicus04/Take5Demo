...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FFImageLoading.Cache.LRUCache, FFImageLoading.Maui", LRUCache.class, __md_methods);
	}
	...
	public LRUCache (int p0)
	{
		...
		if (getClass () == LRUCache.class) {
			mono.android.TypeManager.Activate ("FFImageLoading.Cache.LRUCache, FFImageLoading.Maui", "System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0 });
		}
	}
